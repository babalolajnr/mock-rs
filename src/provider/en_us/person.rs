...
pub struct Person<'a> {
    ...
    first_name_male: Vec<&'a str>,
    last_name: Vec<&'a str>,
    suffix: Vec<&'a str>,
    title_male: Vec<&'a str>,
...
impl<'a> Person<'_> {
    pub fn new() -> Person<'a> {
        Person {
            ...
            title_male: vec!["Mr.", "Dr.", "Prof."],
            title_female: vec!["Mrs.", "Ms.", "Miss", "Dr.", "Prof."],
        }
    }
...
mod tests {
    ...
    fn first_name_male() {
        ...
        assert!(first_name_male.len() > 1);
        assert!(person.first_name_male.contains(&first_name_male.as_str()));
    }
}
